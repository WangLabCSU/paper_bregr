...
lm_batch_bregr_save = function(data, cores = 1L) {
  ...
  options(bregr.path = tempfile())
  on.exit(options(bregr.save_model = FALSE))
  
  lm_batch_bregr(data, cores)
}
...
ev = microbenchmark(
  ...
  batch_lm_bregr_parallel_10 = lm_batch_bregr(sample_data(data, 10), cores = 4),
  batch_lm_bregr_save_10 = lm_batch_bregr_save(sample_data(data, 10)),
  batch_lm_bregr_save_parallel_10 = lm_batch_bregr_save(sample_data(data, 10), cores = 4),
  batch_lm_for_10 = lm_batch_for(sample_data(data, 10)),
  
  batch_lm_bregr_50 = lm_batch_bregr(sample_data(data, 50)),
  batch_lm_bregr_parallel_50 = lm_batch_bregr(sample_data(data, 50), cores = 4),
  batch_lm_bregr_save_50 = lm_batch_bregr_save(sample_data(data, 50)),
  batch_lm_bregr_save_parallel_50 = lm_batch_bregr_save(sample_data(data, 50), cores = 4),
  batch_lm_for_50 = lm_batch_for(sample_data(data, 50)),
  
  batch_lm_bregr_250 = lm_batch_bregr(sample_data(data, 250)),
  batch_lm_bregr_parallel_250 = lm_batch_bregr(sample_data(data, 250), cores = 4),
  batch_lm_bregr_save_250 = lm_batch_bregr_save(sample_data(data, 250)),
  batch_lm_bregr_save_parallel_250 = lm_batch_bregr_save(sample_data(data, 250), cores = 4),
  batch_lm_for_250 = lm_batch_for(sample_data(data, 250)),
  
  
  batch_lm_bregr_1000 = lm_batch_bregr(sample_data(data, 1000)),
  batch_lm_bregr_parallel_1000 = lm_batch_bregr(sample_data(data, 1000), cores = 4),
  batch_lm_bregr_save_1000 = lm_batch_bregr_save(sample_data(data, 1000)),
  batch_lm_bregr_save_parallel_1000 = lm_batch_bregr_save(sample_data(data, 1000), cores = 4),
